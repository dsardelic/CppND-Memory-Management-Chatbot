...
ChatBotFrame::ChatBotFrame(const wxString& title)
  ...
  _userTextCtrl = new wxTextCtrl(
      ctrlPanel, idTextXtrl, "", wxDefaultPosition, wxSize(width, 50),
      wxTE_PROCESS_ENTER, wxDefaultValidator, wxTextCtrlNameStr
  );
  Connect(
      idTextXtrl, wxEVT_TEXT_ENTER, wxCommandEventHandler(ChatBotFrame::OnEnter)
  );
...
ChatBotPanelDialogItem::ChatBotPanelDialogItem(
  ...
  _chatBotTxt = new wxStaticText(
      this, wxID_ANY, text, wxPoint(-1, -1), wxSize(150, -1),
